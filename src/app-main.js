            ...
            <v-fade-transition mode="out-in">
                <v-container v-if="state.visible">
                    ...
                    <div class="d-flex flex-column mt-4" :class="display.xs.value ? 'ga-4' : 'ga-6'">
                        ...
                        <v-card elevation="0" rounded="lg" :class="{ 'shadow-1': !theme.global.current.value.dark }" id="profile">
                            <v-fade-transition mode="out-in">
                        ...
                        <v-card elevation="0" rounded="lg" :class="{ 'shadow-1': !theme.global.current.value.dark }" id="skills">
                            <v-fade-transition mode="out-in">
                                <v-card-text v-if="state.contents.skills" v-html="state.contents.skills" />
                                <v-skeleton-loader v-else class="ma-2" type="article, text"></v-skeleton-loader>
                            </v-fade-transition>
                        </v-card>
                        <v-card elevation="0" rounded="lg" :class="{ 'shadow-1': !theme.global.current.value.dark }" id="works">
                            <v-fade-transition mode="out-in">

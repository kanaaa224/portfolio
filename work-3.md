...
[アドレス: ponzu.server-on.net/status（自宅サーバー）](//ponzu.server-on.net/status/?from=portfolio)  
[ソースコード リポジトリ（GitHub）](//github.com/kanaaa224/home-server-web-apps)  
[動作の様子（YouTube）](//youtu.be/iXysyyxaWfs)

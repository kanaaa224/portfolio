...
[アドレス: ponzu.server-on.net/music（自宅サーバー）](https://ponzu.server-on.net/music/?from=portfolio)

### 概要

Web開発の更なる学習のため、難易度が少し高い音楽ストリーミングサービスの開発をしています。
...
2024/08:  
開発を中止し、Vue.jsを採用した新しいバージョンを開発開始
